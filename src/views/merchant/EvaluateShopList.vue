<template>
  <div class="publicLine">
    <psearch :selectValue="selectValue" :options="selectList" :searchInout="searchValue" @searchEvent="searchEvent"/>
    <el-table
      :data="tableData"
      stripe border
      style="width: 100%">
...
export default {
  data () {
    return {
      ...
      evaluateTypeList: ['全部', '与产品相符', '服务态度', '发货速度', '配送服务'],
  ...
  methods: {
    init () {
      var list = [{ productName: '三只松鼠', userName: '王小虎', des: '太好吃了', attitu: '3', speed: '5', deliver: '4', tallyScore: '4' }, { productName: '普洱茶', userName: '张成', des: '好喝不上火', attitu: '1', speed: '4', deliver: '1', tallyScore: '2' }, { productName: '铁观音', userName: '卢本伟', des: '不错不错，下次再来', attitu: '2', speed: '4', deliver: '4', tallyScore: '3' }, { productName: '茉绿茶', userName: '何美美', des: '美颜，瘦身', attitu: '4', speed: '3', deliver: '1', tallyScore: '5' }]
